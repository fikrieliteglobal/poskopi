...
$sql = "SELECT * FROM barang WHERE kategori_barang_id = 3 OR kategori_barang_id = 4 OR kategori_barang_id = 5 OR kategori_barang_id = 6";
        ...
        <form action="function.php" method="post">
            <div class="card-body">
                <div class="form-group">
                    <label for="nama_orang">Nama Pembeli</label>
                    <input type="text" class="form-control" id="nama_orang" name="nama_orang">
                </div>
                <div class="form-group">
                    <label for="tanggal">Tanggal</label>
                    <input value="<?= date('Y-m-d'); ?>" type="date" class="form-control col-2" id="tanggal" name="tanggal" required>
                </div>
                <div class="form-group">
